...
#include "MMC_StaggerDamage.h"
#include "../LostArkPlayerAttributeSet.h"

UMMC_StaggerDamage::UMMC_StaggerDamage()
{
...
float UMMC_StaggerDamage::CalculateBaseMagnitude_Implementation(const FGameplayEffectSpec& Spec) const
{
